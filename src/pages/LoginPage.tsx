...
function Dot() {
  return (
    <span style={{ display: "inline-block", width: "3px", height: "3px", borderRadius: "50%", background: "rgba(255,255,255,0.4)", verticalAlign: "middle", margin: "0 10px" }} />
  );
}
...
function FeatureCarousel() {
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", position: "relative", zIndex: 1 }}>
      ...
      <p style={{ color: "#9ca3af", fontSize: "14px", lineHeight: 1.7, marginBottom: "44px", maxWidth: "340px" }}>
...
export default function LoginPage() {
  ...
  const ComplianceLine = ({ dark }: { dark?: boolean }) => (
    <p style={{ fontSize: "12px", color: dark ? "#6b7280" : "var(--text-secondary)", display: "flex", alignItems: "center" }}>
      {dark ? (
        <>HIPAA Certified<Dot />SOC 2 Type II<Dot />FHIR Ready</>
      ) : (
        <>
          HIPAA Certified
          <span style={{ display: "inline-block", width: "3px", height: "3px", borderRadius: "50%", background: "var(--text-secondary)", opacity: 0.5, verticalAlign: "middle", margin: "0 10px" }} />
          SOC 2 Type II
          <span style={{ display: "inline-block", width: "3px", height: "3px", borderRadius: "50%", background: "var(--text-secondary)", opacity: 0.5, verticalAlign: "middle", margin: "0 10px" }} />
          FHIR Ready
        </>
