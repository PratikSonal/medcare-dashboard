    ...
    >
      {success ? (
        ...
        >
          ...
          <p style={{ fontSize: "16px", fontWeight: 600, color: "#93c5fd", marginBottom: "6px" }}>
            Account created
          </p>
        ...
        <>
          ...
          <form onSubmit={handleRegister} className="flex flex-col gap-[14px]">
            <div className="flex flex-col gap-[6px]">
              <label style={{ fontSize: "13px", fontWeight: 500, color: "#64748b" }}>
                Full name
              </label>
          ...
          <p className="text-center text-[13px] mt-5" style={{ color: "#334155" }}>
            ...
            <Link to="/login" className="no-underline font-medium" style={{ color: "#3b82f6" }}>
              Sign in
            </Link>
          </p>
        </>
