...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 font-sans" style={{ background: '#070d1a' }}>
      <motion.div
      ...
      >
                ...
                <div className="flex flex-col gap-[6px]">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      style={{ background: '#0d1b33', border: '0.5px solid #1e3a5f', color: '#e2e8f0', transition: 'border-color 200ms ease' }}
        ...
        <div className="text-center mt-5 flex items-center justify-center gap-4">
          {['HIPAA', 'SOC 2', 'FDA Ready'].map(b => (
            <span key={b} className="text-[11px] font-medium" style={{ color: '#1e3a5f' }}>{b}</span>
          ))}
        </div>
      </motion.div>
    </div>
