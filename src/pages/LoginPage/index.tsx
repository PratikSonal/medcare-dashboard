  ...
  const handleSubmit = async (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    try {
      if (isRegister) {
        ...
        showWelcomeNotification(
          result.user.displayName || result.user.email || "Doctor",
        );
      }
      navigate("/dashboard");
    } catch (err: unknown) {
  ...
  return (
    <div className="dot-grid min-h-screen flex bg-bg-primary">
      ...
      >
        ...
        <div
          style={{ padding: "40px 48px 0", position: "relative", zIndex: 1 }}
        >
        ...
        >
          <div
            className="glow-line"
            style={{ marginBottom: "20px", width: "56px" }}
          />
          <h1
            style={{
              fontSize: "36px",
          ...
          >
            A unified platform for modern healthcare teams — monitor patients,
            schedule appointments, and deliver exceptional care.
          </p>
          <FeatureCarousel />
        </div>

        <div
          style={{ padding: "0 48px 40px", position: "relative", zIndex: 1 }}
        >
          <p
            style={{
              fontSize: "12px",
