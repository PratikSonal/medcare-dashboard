...
export const AuthForm = () => {
  ...
  const handleSubmit = useCallback(async (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const msg = ERROR_MESSAGES[code] || (isRegister ? 'Registration failed. Please try again.' : 'Login failed. Please try again.');
      setLocalError(msg);
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-[14px]">
              ...
              <div className="flex flex-col gap-[6px]">
                <div className="flex items-center justify-between">
                  ...
                  {!isRegister && (
                    <button type="button" className="text-xs text-accent-blue bg-transparent border-0 cursor-pointer font-sans p-0">
                      Forgot password?
                    </button>
                  )}
                </div>
