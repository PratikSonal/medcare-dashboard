      ...
      >
            ...
            <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: "13px",
                  fontWeight: 500,
                  border: `1px solid ${hasActiveFilters ? "rgba(60,131,246,0.4)" : "var(--border-primary)"}`,
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <div
                            style={{ textAlign: "center", minWidth: "48px" }}
                          >
                            <p
                              style={{
                                fontSize: "15px",
                            ...
                            <span
                              style={{
                                ...
                                background: app.intakeComplete
                                  ? "rgba(14,165,233,0.1)"
                                  : "rgba(245,158,11,0.1)",
                                color: app.intakeComplete
                                  ? "#0ea5e9"
                                  : "#f59e0b",
                                border: `1px solid ${app.intakeComplete ? "rgba(14,165,233,0.2)" : "rgba(245,158,11,0.2)"}`,
                              }}
                            >
                            ...
                            <span
                              style={{
                                ...
                                background: app.insuranceVerified
                                  ? "rgba(14,165,233,0.1)"
                                  : "rgba(239,68,68,0.1)",
                                color: app.insuranceVerified
                                  ? "#0ea5e9"
                                  : "#ef4444",
                                border: `1px solid ${app.insuranceVerified ? "rgba(14,165,233,0.2)" : "rgba(239,68,68,0.2)"}`,
                              }}
                            >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          >
            ...
            >
              <User size={15} style={{ color: "var(--accent-blue)" }} /> Doctor
              Schedules
            </h3>
            <div
              style={{ display: "flex", flexDirection: "column", gap: "10px" }}
          ...
          >
            ...
            >
              <Clock size={15} style={{ color: "var(--accent-cyan)" }} /> Time
              Slots
            </h3>
            {todayAll.length === 0 ? (
              <p
                ...
                <div style={{ display: "flex", gap: "12px" }}>
                  <div
                    style={{
                      ...
                      borderRadius: "14px",
                      textAlign: "center",
                      background: selectedApp.intakeComplete
                        ? "rgba(14,165,233,0.08)"
                        : "rgba(245,158,11,0.08)",
                      border: `1px solid ${selectedApp.intakeComplete ? "rgba(14,165,233,0.2)" : "rgba(245,158,11,0.2)"}`,
                    }}
                  >
                    ...
                    <p
                      style={{
                        fontSize: "12px",
                        fontWeight: 600,
                        color: selectedApp.intakeComplete
                          ? "#0ea5e9"
                          : "#f59e0b",
                      }}
                    >
                  ...
                  <div
                    style={{
                      ...
                      borderRadius: "14px",
                      textAlign: "center",
                      background: selectedApp.insuranceVerified
                        ? "rgba(14,165,233,0.08)"
                        : "rgba(239,68,68,0.08)",
                      border: `1px solid ${selectedApp.insuranceVerified ? "rgba(14,165,233,0.2)" : "rgba(239,68,68,0.2)"}`,
                    }}
                  >
                    <p style={{ fontSize: "20px", marginBottom: "4px" }}>
                    ...
                    <p
                      style={{
                        fontSize: "12px",
                        fontWeight: 600,
                        color: selectedApp.insuranceVerified
                          ? "#0ea5e9"
                          : "#ef4444",
                      }}
                    >
