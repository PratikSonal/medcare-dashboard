  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-[10px] px-4 py-5 shrink-0">
        <div className="w-9 h-9 rounded-[10px] flex items-center justify-center shrink-0" style={{ background: 'var(--gradient-primary)' }}>
      ...
      <div className="p-2 shrink-0 border-t border-border-primary">
        {user && (
          <div className="flex items-center gap-[10px] px-3 py-[10px] mb-1 rounded-12 bg-bg-tertiary">
            <div className="w-[30px] h-[30px] rounded-full flex items-center justify-center text-xs font-bold text-white shrink-0" style={{ background: 'var(--gradient-primary)' }}>
        ...
        <button
          ...
          className={cn('flex items-center gap-3 px-3 py-[10px] rounded-12 w-full border-0 bg-transparent cursor-pointer text-text-secondary font-sans', styles.logoutBtn)}
        >
